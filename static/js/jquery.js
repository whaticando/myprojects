...
+(function (a) {
    a(document).ready(function () {
                    ...
                    case "comment-insert-smilie":
                        if (!a("#comment-smilies").length) {
                            ...
                            for (key in g.smilies) {
                                x += '<img data-simle="' + key + '" data-type="comment-smilie" src="' + _deel.url + "static/comment/weibo/" + g.smilies[key] + '.png">'
                            }
        ...
        var g = {
            smilies: {
                "aini_org": "aini_org",
                "baibai_thumb": "baibai_thumb",
                "baobao_thumb": "baobao_thumb",
                "beishang": "beishang_org",
                "bingbujiandan": "bingbujiandan_thumb",
                "bishi": "bishi_org",
                "bizui": "bizui_org",
                "chigua": "chigua_thumb",
                "chongjing": "chongjing_org",
                "dahaqian": "dahaqian_org",
                "dalian": "dalian_org",
                "ding": "ding_org",
                "doge02": "doge02_org",
                "erha": "erha_org",
                "gui": "gui_org",
                "guzhang": "guzhang_thumb",
                "haha": "haha_thumb",
                "heng": "heng_thumb",
                "huaixiao": "huaixiao_org",
                "huaxin": "huaxin_org",
                "jiyan": "jiyan_org",
                "kelian": "kelian_org",
                "ku": "ku_org",
                "kuxiao": "kuxiao_org",
                "leimu": "leimu_org",
                "miaoiao": "miaomiao_thumb",
                "ningwen": "ningwen_org",
                "nu": "nu_thumb",
                "qian": "qian_thumb",
                "sikao": "sikao_org",
                "taikaixin": "taikaixin_org",
                "tanshou": "tanshou_org",
                "tianping": "tianping_thumb",
                "touxiao": "touxiao_org",
                "tu": "tu_org",
                "wabi": "wabi_thumb",
                "weiqu": "weiqu_thumb",
                "wenhao": "wenhao_thumb",
                "wosuanle": "wosuanle_thumb",
                "wu": "wu_thumb",
                "xiaoerbuyu": "xiaoerbuyu_org",
                "xiaoku": "xiaoku_thumb",
                "xixi": "xixi_thumb",
                "yinxian": "yinxian_org",
                "yun": "yun_thumb",
                "zhouma": "zhouma_thumb",
                "zhuakuang": "zhuakuang_org",
